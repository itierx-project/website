    ...
    return (
        <>
            <motion.nav
                ...
                className="fixed top-0 left-0 right-0 h-24 flex items-center justify-between px-8 md:px-12 md:pl-32 z-[60] bg-transparent backdrop-blur-sm lg:backdrop-blur-none"
            >
